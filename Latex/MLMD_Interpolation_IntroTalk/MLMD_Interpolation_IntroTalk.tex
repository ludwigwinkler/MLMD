	...
	\begin{figure}[!htbp]
		\begin{adjustbox}{max width = 0.3\textwidth, height = 0.6\textheight}
			\begin{tikzpicture}[scale=2]
				...
				\draw [-latex, ultra thick, black] (0,-0.1) -- (0,2) node[at end, left] {};
				\draw [-latex, ultra thick, black] (-0.1,0) -- node[at end, below=0.5cm] {\large Time} (6.5,0);
				...
				\draw[black, thick, dashed] (t0) |- (0,0);
				\draw[black, thick, dashed] (t1) |- (0,0);
				\draw[black, thick, dashed] (t2) |- (0,0);
				\draw[black, thick, dashed] (t3) |- (0,0);
				\draw[black, thick, dashed] (t4) |- (0,0);
				...
				\onslide<5->{
				\draw [red, thick] (0.1, 0.1)   to [out=60, in=180] (1.5,1.5)
				...
				\onslide<6->{
				\draw[thick] (4.25,0.9) rectangle ++(2,1);
				...
				\begin{tikzpicture}[scale=3, thick]
					...
					\draw[ultra thick] (4.25,0.9) rectangle ++(2,1.5);
					\draw [red, thick] (0.1, 0.1)   to [out=0, in=180] (3,0.25)
													to [out=0, in=135] (6,1.5)
													to [out=315, in=135] ++(315:0.5cm);
			
					\node[simpoint] (t3) at (4.5,1.03){};
					\node[simpoint] (t4) at (6.,1.44){};
					\draw[black, thick] (t3) to (t4);
			
					\draw[black, thick] (4.5, 2.) to (6, 2.);
					\foreach \x in {4.5,5.,5.5,6.}
						\draw[black, thick] (\x,1.9) -- (\x,2.1);
			
					\draw[red, thick] (5, 2.) to (5.5, 2.);
					\foreach \x in {5.,5.5,}
						\draw[red, thick] (\x,1.9) -- (\x,2.1);
					
					\node[red, thick] at (5.25, 2.1) {$\Delta \tau$};
					\draw[black, thick, dashed] (4.5, 2.0) |- (t3);
					\draw[black, thick, dashed] (6, 2.0) |- (t4);
			
				\end{tikzpicture}
				};

				\draw[thick] ($(4.24, 0.9)+(0,1)$) -- ($(zoom.south west)+(0.05, 0.09)$);
				\draw[thick] ($(4.24, 0.9)+(2,1)$) -- ($(zoom.north east)+(-0.05, -0.09)$);
				}
...
\begin{frame}
	...
	% 	\end{figure}	
	\begin{figure}[!htbp]
		\begin{adjustbox}{max width = 0.5\textwidth, height = 0.5\textheight}
			\begin{tikzpicture}[scale=2]
				...
				\begin{tikzpicture}[scale=3, thick]
					...
					\draw[black, thick] (t3) to (t4);
					\onslide<7->{
					\draw [red, thick, -latex] (4.5, 1.15) to [out=43, in=190] (5.5,1.8);
					}
					\onslide<8->{
					\draw [red, thick, -latex] (6, 1.4) to [out=130, in=45] (5.,1.35);
					}
					...
					\node[red, thick] at (5.25, 2.1) {$\Delta \tau$};
					\draw[black, thick, dashed] (4.5, 2.0) |- (t3);
					\draw[black, thick, dashed] (6, 2.0) |- ($(t4)+(0, -0.1)$);
	...
	\begin{figure}[!htbp]
		\begin{adjustbox}{max width = 0.3\textwidth, height = 0.4\textheight}
			\begin{tikzpicture}
				...
				\onslide<7->{
				\node (reala100)[node] at ($(a100)+(0,1.0)$) {};
				\draw[black, dotted, arrow, shorten >= 2pt] (a66) to node[above, black] {\scriptsize $\dot{x}(t)$} (reala100);
				\draw[{Bar[]}-{Bar[]}, red, dashed, shorten >= 3pt, shorten <= 3pt] (a100) to node[right]{$\mathcal{L}$} (reala100);
